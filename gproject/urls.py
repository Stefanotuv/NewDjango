...
urlpatterns = [
    ...
    path('GP/wizard_new', GPElaborationCreateView.as_view(template_name='gproject/elaboration_wizard_new.html'),
         name='gproject-gp-wizard-new'),
    path('GP/wizard_new_2', GPElaborationCreateView.as_view(template_name='gproject/elaboration_wizard_new_2.html'),
